...
st.markdown(
    ...
    <div class="min-h-screen bg-white flex flex-col">
      ...
      <main class="px-6 pt-8 flex-grow">
        ...
        <div class="space-y-6">
            ...
            <p class="text-lg text-gray-600">
              Monitor your health vitals using just your smartphone camera.
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">
                      Track BP, SPO2, Heart &amp; Respiratory Rate
                    </p>
                </div>
            </div>
            <div class="flex items-center gap-4">
      ...
      <footer class="p-6">
        ...
        <button onclick="window.parent.location.href='?screen=Measurement'"
                style="width:100%; background-color:#1F2937; color:white; padding:1rem; border:none; border-radius:0.75rem; font-weight:600;">
          Get Started
        </button>
      </footer>
    </div>
