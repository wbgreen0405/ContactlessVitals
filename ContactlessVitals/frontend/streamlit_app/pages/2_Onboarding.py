...
st.markdown(
    ...
    <div style="min-height:100vh; background-color:white; display:flex; flex-direction:column;">
      <header style="padding:1rem; display:flex; justify-content:space-between; align-items:center;">
        <!-- 'Skip' goes to Home (3_Home) -->
        <button onclick="window.location.href='/3_Home'"
                style="background:none;border:none;color:#6B7280;font-size:0.875rem;">
          Skip
        </button>
      ...
      <footer style="padding:1rem;">
        <button onclick="window.location.href='/4_Measurement'"
                style="width:100%;background-color:#111827;color:white;padding:1rem;border:none;
