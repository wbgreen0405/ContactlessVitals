...
st.markdown(
    ...
    .focus\\:ring-opacity-50:focus {
        /* Usually used with box-shadow alpha, already done above */
    }
    .text-xl {
        font-size: 1.25rem;
    }
...
# Now we create the HTML structure inside Streamlit
st.markdown(
    """
        ...
        <div ds-id="camera-permission" ds-name="Card" class="rounded-lg text-base-content flex flex-col bg-base border border-base-200 p-0 shadow text-center">
          <div class="flex h-full flex-col justify-start gap-4 p-6">
            <div class="flex justify-center mb-6">
              <svg class="h-5 w-auto text-current h-16 w-16 text-primary-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div class="flex h-full flex-col justify-start gap-4 p-6">
            <div class="space-y-4">
              <div class="flex items-center gap-2">
                <svg class="h-5 w-auto text-current h-5 w-5 text-primary-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
