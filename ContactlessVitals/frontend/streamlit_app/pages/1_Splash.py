...
# Tailwind + DaisyUI header snippet
daisyui_header = """
<head>
  <!-- Tailwind CSS via CDN -->
  <script src="https://cdn.tailwindcss.com"></script>
  <!-- DaisyUI plugin via CDN -->
...
# The Welcome (Screen 0) HTML using DaisyUI classes
welcome_html = f"""
{daisyui_header}
<body class="h-full text-base-content">
  <div id="welcome-screen" class="min-h-screen bg-gradient-to-b from-blue-50 to-white p-6 flex flex-col justify-between">
    ...
    <div class="space-y-6 text-center mt-12">
      <div ds-name="Card" class="rounded-lg text-base-content flex flex-col bg-base border border-base-200 p-0 shadow max-w-md mx-auto bg-white/80 backdrop-blur">
      ...
      <div class="space-y-4 max-w-md mx-auto">
        ...
        <button ds-variant="primary" ds-size="xl" ds-name="Button"
                class="flex justify-center items-center font-medium transition-colors duration-200 ease-in-out
                       ...
                       rounded-lg bg-primary-500 text-primary-content hover:bg-primary-600 focus:ring-primary-300
        ...
        <button ds-variant="link" ds-name="Button"
                class="flex justify-center items-center font-medium transition-colors duration-200 ease-in-out
                       focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-opacity-50
                       px-5 py-2.5 text-sm rounded-lg bg-transparent text-primary hover:underline hover:text-primary-focus">
...
# Display the welcome screen in Streamlit
