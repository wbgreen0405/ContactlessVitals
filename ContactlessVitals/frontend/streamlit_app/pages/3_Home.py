...
# 1) Page config: wide layout, custom title
st.set_page_config(layout="wide", page_title="Camera Access Required")

# 2) Inject CSS for background, reduced padding, and styled buttons
st.markdown("""
<style>
/* Light gray background, similar to bg-gray-50 */
body {
...
/* Center & style the Streamlit buttons (blue background, white text) */
.stButton > button {
    display: block;                
...
<div style="
  ...
  <div style="text-align: center; margin-bottom: 1rem;">
    <svg style="width:64px; height:64px; color:#3b82f6;" 
      ...
      <path fill-rule="evenodd" d="M4 5a2 2 0 00-2 2v8a2 2 0 
...
# Streamlit button for "Allow Camera Access"
if st.button("Allow Camera Access"):
    st.success("Camera access granted! (Example placeholder)")
...
# Streamlit button for "Read Privacy Policy"
if st.button("Read Privacy Policy"):
    st.info("Privacy policy details here (Example placeholder).")
