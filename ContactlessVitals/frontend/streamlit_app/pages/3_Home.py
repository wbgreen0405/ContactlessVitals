...
/* Center arrow & skip button on top bar columns */
.top-bar-col {
    display: flex; 
    align-items: center; 
...
# 4) Steps in a single card, each with an icon, title, and description
steps = [
    {
        "icon": """<svg style="width:64px; height:64px; color:#3B82F6; display:block; margin:0 auto;" 
                         xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                     <path fill-rule="evenodd" 
                           d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 
                              2 0 002-2V7a2 2 0 00-2-2h-1.586a1 1 0 
                              01-.707-.293l-1.121-1.121A2 2 0 
                              0011.172 3H8.828a2 2 0 
                              00-1.414.586L6.293 4.707A1 1 0 
                              015.586 5H4zm6 9a3 3 0 
                              100-6 3 3 0 000 6z" 
                           clip-rule="evenodd"/>
                   </svg>""",
    ...
    },
    {
        "icon": """<svg style="width:64px; height:64px; color:#3B82F6; display:block; margin:0 auto;"
                         xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                     <path fill-rule="evenodd" 
                           d="M10 2a6 6 0 00-4.472 10.09 8 
                              8 0 018.944 0A6 6 0 0010 
                              2zm-2 7a2 2 0 114 
                              0 2 2 0 01-4 0zM2 
                              13.5a7.5 7.5 0 0115 
                              0v.45c0 .786-.43 
